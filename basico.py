...
msg['To'] = "lista_de_destinatarios.txt"
...
server.sendmail("seuemail@gmail.com", "emaildestino@exemplo.com", mensagem)
server.quit()
...
# Análise de dados:
# Importar um arquivo CSV usando a biblioteca pandas e calcular algumas estatísticas básicas:
...
# calcular a média, desvio padrão e mediana de uma coluna
